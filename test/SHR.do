vsim -gui work.cpu
# SHR R2, 3 | R2 = 8
mem load -filltype value -filldata 0000011100100010 -fillradix symbolic /cpu/RAM_inst/ram(0)
mem load -filltype value -filldata 0000000000000011 -fillradix symbolic /cpu/RAM_inst/ram(1)
...
force -freeze sim:/cpu/RegFile/R_output(2) 10#8 0
