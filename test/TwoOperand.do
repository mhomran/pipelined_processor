...
mem load -i D:/Arch_project/pipelined_processor/test_cases/TwoOperand.mem /cpu/RAM_inst/ram
...
run
run
force -freeze sim:/cpu/IN_PORT/q 16#5 0
run
force -freeze sim:/cpu/IN_PORT/q 16#19 0
run
force -freeze sim:/cpu/IN_PORT/q 16#FFFFFFFF 0
run
force -freeze sim:/cpu/IN_PORT/q 16#FFFFF320 0
run
