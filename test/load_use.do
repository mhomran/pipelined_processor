...
mem load -filltype value -filldata 0000000100100010 -fillradix symbolic /cpu/RAM_inst/ram(2)
...
mem load -filltype value -filldata 0000000000000011 -fillradix symbolic /cpu/RAM_inst/ram(11)
...
add wave -position end  sim:/cpu/MEM_to_EX_Forwarding_Dst
add wave -position end  sim:/cpu/MEM_to_EX_Forwarding_Src
