vsim -gui work.cpu
# OUT
mem load -filltype value -filldata 0001001000000000 -fillradix symbolic /cpu/RAM_inst/ram(0)
...
add wave -position end sim:/cpu/output_port
add wave -position end sim:/cpu/RegFile/R(0)/R_reg/q

force -freeze sim:/cpu/clk 0 0, 1 {50 ps} -r 100
force -freeze sim:/cpu/rst 1 0
force -freeze sim:/cpu/input_port 16#FF 0
force -freeze sim:/cpu/RegFile/R(0)/R_reg/q 10#1 0
run
run
