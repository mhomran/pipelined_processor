...
add wave -position end sim:/cpu/RAM_inst/*
add wave -position end sim:/cpu/SP/*
mem load -i D:/Arch_project/pipelined_processor/test_cases/Memory.mem /cpu/RAM_inst/ram
...
force -freeze sim:/cpu/IN_PORT/q 16#19 0
run
force -freeze sim:/cpu/IN_PORT/q 16#FFFF 0
run
force -freeze sim:/cpu/IN_PORT/q 16#F320 0
run
...
force -freeze sim:/cpu/IN_PORT/q 16#10 0
run
